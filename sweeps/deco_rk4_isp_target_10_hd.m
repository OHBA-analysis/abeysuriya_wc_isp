function p = deco_rk4_isp_target_10_hd()
	% Set up the unit
	u = ra.unit.deco_10;
	noise_mu = [0.31 0];
	...
	p = ra.sweep.simulate_plasticity_fill_in(ra.network.import('stam_cortical'),u,velocity,coupling,isp_target,'deco_rk4_isp_target_10');
